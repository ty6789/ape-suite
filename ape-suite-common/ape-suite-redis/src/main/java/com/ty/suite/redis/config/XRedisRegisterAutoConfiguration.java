package com.ty.suite.redis.config;

import com.ty.suite.redis.annotation.XRedis;
import com.ty.suite.redis.reflect.XRedisFactoryBean;
import com.ty.suite.redis.util.SimpleMetadataReader;
...
@ConditionalOnProperty(name = {"ty.suite.redis"}, havingValue = "true", matchIfMissing = false)
